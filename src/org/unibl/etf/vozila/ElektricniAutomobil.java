...
public class ElektricniAutomobil extends PrevoznoSredstvo {
    ...
    public ElektricniAutomobil(String jedinstveniIdentifikator, double cijenaNabavke, String proizvodjac, String model, int trenutniNivoBaterije, String datumNabavke, String opis) {
